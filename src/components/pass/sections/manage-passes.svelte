<script lang="ts">
  ...
  import { Upload } from "lucide-svelte";
    import PassesTable from "../Tables/passes-table.svelte";
  const fruits = [
...
<div class="p-4 h-full w-full flex flex-col gap-10">
  <div class="flex items-center justify-between">
    <span class="flex flex-col gap-1">
      <p class="text-black font-medium text-lg">Manage Passes</p>
      <p class="text-black/[.5] text-base">
        Keep a detailed record of all the passes generated
      </p>
    </span>
